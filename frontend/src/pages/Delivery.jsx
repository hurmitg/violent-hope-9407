    ...
    return (
      <>
        ...
        <Box
          ...
          gap="30px"
        >
          <Box w={["100%","50%","50%"]} m={{base:"auto"}} h="100%" border={"0px"}>
            <VStack align={"left"}>
              <Text>SHIPPING ADDRESS</Text>
              <Text color={"gray.500"} fontSize="14px">Please enter your shipping address in the form below</Text>
          ...
          <Divider display={["none","block","block"]} orientation={"vertical"} h={"300px"} />
  
          {/* second box */}
          <Box w={["100%","50%","50%"]} m={{base:"auto"}} h="100%" border={"1px solid white"}>
             
             <VStack align={"left"}>
              <Text>SHIPPING METHOD</Text>
              <Text color={"gray.500"} fontSize="14px">Please select your preferred shipping method.</Text>
              <Divider/>
               <Text>Express</Text>
               <Text color={"gray.500"} fontSize="14px">2-4 business days delivery time</Text>
                  ...
                  <HStack spacing="24px">
                    <Radio value="Mytheresa packaging">
                      <VStack align={"left"}>
                        ...
                        <Text color={"gray.500"} fontSize="14px">Free</Text>
                        <Img w="90px" src="https://www.mytheresa.com/skin/frontend/mytheresa/default/images/package/package_mytheresa_2x.jpg"/>
                      </VStack>
                    </Radio>
                    <Radio value="Eco packaging">
                      <VStack align={"left"} >
                        ...
                        <Text color={"gray.500"} fontSize="14px">Free</Text>
                        <Img w="90px" src="https://www.mytheresa.com/skin/frontend/mytheresa/default/images/package/package_brown_2x.jpg"/>
                      </VStack>
                    </Radio>
              ...
              <Checkbox color={"gray.500"} fontSize="14px" >Help offset the CO2 emissions of your order</Checkbox>
